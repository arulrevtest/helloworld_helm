...
DOCKER_USR=${DOCKER_USR:-arulkumar1967}
DOCKER_PSW=${DOCKER_PSW:-sumathi123}

DOCKER_REPO=${DOCKER_REPO:-arulkumar1967}
DOCKER_TAG=${DOCKER_TAG:-rev_helloworld_helm}
...
${SCRIPT_NAME} - Script for building the Helloworld web application, Docker image and Helm chart
...
packHelmChart() {
    ...
    helm package -d ${BUILD_DIR}/helm ${SCRIPT_DIR}/helm/helloworld || errorExit "Packing helm chart ${SCRIPT_DIR}/helm/helloworld failed"
}
